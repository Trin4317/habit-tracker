                        ...
                        >
                            ...
                            <div class="mt-2">
                                <div>
                                    ...
                                    <input type="text" name="name" v-model="habits.formData.name"
                                ...
                                <div class="mt-2">
                                    ...
                                    <input type="text" name="times_per_day" v-model="habits.formData.times_per_day"
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-600"
                                    >
                            ...
                            <div class="mt-4">
                                <button :disabled="loading" @click="$event => storeHabit()" type="button" class="inline-flex items-center bg-primary-600 px-3.5 py-2 rounded-md text-sm font-medium text-white">
